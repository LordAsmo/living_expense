			...
			<div class="card mb-3 mt-5">
				...
				<div class="card-body">
					...
					<form action="login" method="post">
						...
						<p style="clear: both; font-size: 0.8rem;">Does not have an account? Sign up <a href="user" class="text-decoration-none text-muted" style="font-style:oblique; font-weight:bold;">here</a>.</p>
					</form>
				</div>
			</div>
		</div>
